<template>
    <div class="px-6 py-3">
        ...
        <div class="flex items-center justify-between">
            <h1 class="pl-2 text-2xl font-semibold text-white tracking-wider hover:underline">Canzoni</h1>
        ...
        <div class="w-full flex flex-wrap">
            <div v-for="canzone in canzoni" v-bind:key="canzone.id" class="p-2 w-48 relative">
                ...
                <div class="bg-light w-full h-auto p-5 rounded-lg shadow-md">
                    <img :src="canzone.copertina" alt="" class="h-auto w-full shadow mb-2">
